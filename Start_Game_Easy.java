...
class Start_Game_Easy extends JPanel {

    ImageIcon Sanam = new ImageIcon(this.getClass().getResource("sanam2.jpg"));
    ...
    public Start_Game_Easy() {
        ...
        addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (intesect(getbound(e.getX(), e.getY()), cred.getbound()) && !cred.status_click && !cpurple.status_click && !cyellow.status_click) {
                    if (z == 1) {
                ...
                if (intesect(getbound(e.getX(), e.getY()), cpurple.getbound()) && !cpurple.status_click && !cred.status_click && !cyellow.status_click) {
                    if (z == 2) {
                ...
                if (intesect(getbound(e.getX(), e.getY()), cyellow.getbound()) && !cyellow.status_click && !cred.status_click && !cpurple.status_click) {
                    if (z == 3) {
        ...
        cred = new Car(145, 170, 100, 100, 2) {
    ...
    protected void paintComponent(Graphics g) {
        ...
        if (cred.x == 145 && cred.y == 635 && cyellow.x == 145 && cyellow.y == 170 && cpurple.x == 800 && cpurple.y == 635) {
    ...
    class gamewin extends JPanel {
            ...
            addMouseListener(new MouseAdapter() {
                ...
                public void mouseClicked(MouseEvent e) {
                    ...
                    if (mx >= 775 && mx <= 940 && my >= 610 && my <= 670) {
                        ...
                        Start_Game_Easy start = new Start_Game_Easy();
                        add(start);
                        start.setFocusable(true);
                    }
        ...
        protected void paintComponent(Graphics g) {
            ...
            g.drawString(String.valueOf(20 - Second) + " SECOUND", 50, 720);
            g.setColor(Color.white);
